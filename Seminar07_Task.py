...
def same_by(func, collection):
    return len(list(filter(func, collection))) == 0 # идет проверка на выполнение условия, записанного в lambda. Если 
                                                    # значение не удовл заданному условию - элемент сохраняется в список.
                                                    # по завершении работы список будет содержать значения, не удовл условию. 
                                                    # откуда следует, что если длина списка != 0 - условие выполняется 
                                                    # не для всего списка -> false
